...
@Disabled
public class AutoOpRed2 extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            DriveForwardGyro(1000,0.2);
            Thread.sleep(500);
            DriveBackGyro(-1000,0.2);
    ...
    public void DriveBackGyro(int distance, double power){
